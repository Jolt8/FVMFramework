function PAM_reforming_react_cell!(du, u, cell_id, vol)
    ...
    K_eq_MSR = K_gibbs_free(u, cell, u.reactions.reforming_reactions.MSR_rxn)
    ...
    K_eq_MD = K_gibbs_free(u, cell, u.reactions.reforming_reactions.MD_rxn)
    ...
    K_eq_WGS = K_gibbs_free(u, cell, u.reactions.reforming_reactions.WGS_rxn)
    ...
    for species_name in propertynames(u.molar_concentrations[:])
        for reforming_reaction in u.reactions.reforming_reactions
    ...
    for reforming_reaction in u.reactions.reforming_reactions
        du.temp[cell_id] += u.net_rates.reforming_reactions[reforming_reaction] * (-u.reactions.reforming_reactions[reforming_reaction].heat_of_reaction) * vol #this causes GC
