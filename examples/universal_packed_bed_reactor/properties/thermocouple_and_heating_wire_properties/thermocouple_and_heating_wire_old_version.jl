function get_heating_wire_and_thermocouple_properties(pipe_length, n_cells_axial, region_cells, region_cell_lengths_along_pipe)

    TC1_closest_cell_id = argmin(abs.(region_cell_lengths_along_pipe .- (1.5u"inch")))
    TC2_closest_cell_id = argmin(abs.(region_cell_lengths_along_pipe .- (3.0u"inch")))
    TC3_closest_cell_id = argmin(abs.(region_cell_lengths_along_pipe .- (5.0u"inch")))
    TC4_closest_cell_id = argmin(abs.(region_cell_lengths_along_pipe .- (7.5u"inch")))
    TC5_closest_cell_id = argmin(abs.(region_cell_lengths_along_pipe .- (10.0u"inch")))
