# ═══════════════════════════════════════════════════════════════════════
# FVM Setup File — Generated by Tracer
# Fill in values for each region below, then include() this file.
# ═══════════════════════════════════════════════════════════════════════
...
# These are the variables the ODE solver evolves over time.
# Specify initial values for each region.
...
# ── Fixed Properties ─────────────────────────────────────────────────
# These are parameters that never change during simulation.
# Specify values for each region.
